...
def SmallUNetFCNN(img_dim=(256,256)):
    ...
    generator_E1 = SymmetricPadding()(generator_E1)
    #generator_E1 = Dropout(0.5)(generator_E1)
    ...
    generator_E2 = SymmetricPadding()(generator_E2)
    #generator_E2 = Dropout(0.5)(generator_E2)
    #generator_E2 = Conv2D(32, (1,1), activation="relu")(generator_E2)
    generator_E2D = MaxPooling2D((2,2))(generator_E2)

    # Encoder block 3
    generator_E3 = Conv2D(128, (3,3), activation="relu")(generator_E2D)
    generator_E3 = SymmetricPadding()(generator_E3)
    #generator_E3 = Conv2D(32, (1,1), activation="relu")(generator_E3)
    #generator_E3 = Dropout(0.5)(generator_E3)
    generator_E3D = MaxPooling2D((2,2))(generator_E3)

    # Bottleneck
    generator_BN = Conv2D(256, (3,3), activation="relu")(generator_E3D)
    generator_BN = SymmetricPadding()(generator_BN)
    #generator_BN = Conv2D(32, (1,1), activation="relu")(generator_BN)
    #generator_BN = SymmetricPadding()(generator_BN)
    ...
    generator_D3 = SymmetricPadding()(generator_D3)
    #generator_D3 = Conv2D(32, (1,1), activation="relu")(generator_D3)
    ...
    generator_D2 = SymmetricPadding()(generator_D2)
    #generator_D2 = Conv2D(32, (1,1), activation="relu")(generator_D2)
    ...
    generator_D1 = SymmetricPadding()(generator_D1)
    generator_D1 = Conv2D(32, (3,3), activation="relu")(generator_D1)
    generator_D1 = SymmetricPadding()(generator_D1)
