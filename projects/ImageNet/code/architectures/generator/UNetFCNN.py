...
def UNetFCNN(img_dim=(256,256)):
    ...
    # Encoder
    # Encoder block 1
    generator_E1 = Conv2D(32, (3,3), activation="relu", padding="same")(generator_input)
    generator_E1 = Conv2D(32, (3,3), activation="relu", padding="same")(generator_E1)
    generator_E1D = MaxPooling2D((2,2))(generator_E1)

    # Encoder block 2
    generator_E2 = Conv2D(64, (3,3), activation="relu", padding="same")(generator_E1D)
    generator_E2 = Conv2D(64, (3,3), activation="relu", padding="same")(generator_E2)
    generator_E2D = MaxPooling2D((2,2))(generator_E2)

    # Encoder block 3
    generator_E3 = Conv2D(128, (3,3), activation="relu", padding="same")(generator_E2D)
    generator_E3 = Conv2D(128, (3,3), activation="relu", padding="same")(generator_E3)
    generator_E3D = MaxPooling2D((2,2))(generator_E3)

    # Bottleneck
    generator_BN = Conv2D(256, (3,3), activation="relu", padding="same")(generator_E3D)
    generator_BN = Conv2D(256, (3,3), activation="relu", padding="same")(generator_BN)

    # Decoder
    # Decoder block 3
    generator_D3U = UpSampling2D((2,2))(generator_BN)
    generator_D3 = Concatenate(axis=-1)([generator_D3U, generator_E3])
    generator_D3 = Conv2D(128, (3,3), activation="relu", padding="same")(generator_D3)
    generator_D3 = Conv2D(128, (3,3), activation="relu", padding="same")(generator_D3)

    # Decoder block 2
    generator_D2U = UpSampling2D((2,2))(generator_D3)
    generator_D2 = Concatenate(axis=-1)([generator_D2U, generator_E2])
    generator_D2 = Conv2D(64, (3,3), activation="relu", padding="same")(generator_D2)
    generator_D2 = Conv2D(64, (3,3), activation="relu", padding="same")(generator_D2)

    # Decoder block 1
    generator_D1U = UpSampling2D((2,2))(generator_D2)
    generator_D1 = Concatenate(axis=-1)([generator_D1U, generator_E1])
    generator_D1 = Conv2D(32, (3,3), activation="relu", padding="same")(generator_D1)
    generator_D1 = Conv2D(32, (3,3), activation="relu", padding="same")(generator_D1)
